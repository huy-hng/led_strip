...
// rotary encoder
const uint8_t pin_clk = 2;   // Generating interrupts using CLK signal
const uint8_t pin_dt = 3;    // Reading DT signal
const uint8_t pin_sw = 4;    // Reading Push Button switch
